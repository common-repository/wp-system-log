<?php
/**
 * This file is used for site url and WordPress information.
 *
		...
		<table class="form-table">
			<tbody>
				...
				<tr>
					...
					<td><p class=""><?php echo esc_html( WP_MEMORY_LIMIT ); ?></p></td>
				</tr>
				...
				<tr>
					...
					<td><p class=""><?php echo esc_html( get_locale() ); ?></p></td>
				</tr>
			</tbody>
		</table>
	</div>
