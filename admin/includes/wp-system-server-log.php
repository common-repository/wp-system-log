<?php
/**
 * This file is used for server log.
 *
		...
		<table class="form-table">
			<tbody>
				...
				<tr>
					...
					<td><p class=""><?php echo esc_html( $curl ); ?></p></td>
				</tr>
				...
				<tr>
					...
					<td><p class=""><?php echo esc_html( ini_get( 'upload_max_filesize' ) ); ?></p></td>
				</tr> 

				<!-- DEFAULT TIMEZONE. -->
				<tr>
					<th scope="row"><label for="default-timezone"><?php esc_attr_e( 'Default Timezone', 'wp-system-log' ); ?></label></th>
					<td><p class=""><?php echo esc_html( date_default_timezone_get() ); ?></p></td>
				</tr>
