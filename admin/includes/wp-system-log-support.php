<?php
/**
 * This file is used for system log support.
 *
		...
		<div id="wpsl-settings-tbl">
			...
			<div class="wpsl-admin-row">
				<div>
					...
					<?php
					$wp_system_dev = '<a href="https://wbcomdesigns.com/contact/" target="_blank" title="Custom Development by Wbcom Designs">Custom Development</a>';
					echo '<div class="panel"><p>'
						. sprintf( esc_html( 'If you need additional help you can contact us for %1$s' ), '<span>' . wp_kses_post( $wp_system_dev ) . '</span>' )
						. '<p></div>';
					?>
					</div>
				</div>
