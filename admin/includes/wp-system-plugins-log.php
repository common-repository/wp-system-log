<?php
/**
 * This file is used for system plugin information.
 *
		...
		<table class="form-table">
			<tbody>
				<?php foreach ( $all_plugins as $index => $plugin ) { ?>
					<tr>
						<th scope="row" class="wpsl-plugin-name-th"><label for="plugin-name"><?php echo esc_html( $plugin['Name'] . ' v' . $plugin['Version'] ); ?></label></th>
						<td class="wpsl-plugin-author-td">-<a href="<?php echo esc_url( $plugin['AuthorURI'] ); ?>" target="_blank"><?php echo esc_html( $plugin['Author'] ); ?></a></td>
